...
{
    public class DocumentsClientTest : PerfTest<DocumentsClientTest.DocumentsClientPerfOptions>
    {
        ...
        public DocumentsClientTest(DocumentsClientPerfOptions options) : base(options)
        {
        }
        public class DocumentsClientPerfOptions : PerfOptions
        {
        }
