...
{
    /// <summary>
    /// The set of options that can be specified when calling <see cref="MetricsAdvisorAdministrationClient.GetDataFeeds(GetDataFeedsOptions, CancellationToken)"/>
    /// or <see cref="MetricsAdvisorAdministrationClient.GetDataFeedsAsync(GetDataFeedsOptions, CancellationToken)"/> to configure the behavior of the request.
    /// </summary>
