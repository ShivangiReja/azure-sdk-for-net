...
namespace Azure.ResourceManager.MachineLearningServices
{
    internal partial class ComputeRestOperations
    {
        ...
        internal HttpMessage CreateUpdateSchedulesRequest(string resourceGroupName, string workspaceName, string computeName, ComputeSchedules parameters)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, or <paramref name="computeName"/> is null. </exception>
        public async Task<Response> UpdateSchedulesAsync(string resourceGroupName, string workspaceName, string computeName, ComputeSchedules parameters = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var message = CreateUpdateSchedulesRequest(resourceGroupName, workspaceName, computeName, parameters);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, or <paramref name="computeName"/> is null. </exception>
        public Response UpdateSchedules(string resourceGroupName, string workspaceName, string computeName, ComputeSchedules parameters = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
