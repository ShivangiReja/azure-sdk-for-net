...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class ComputeOperations
    {
        ...
        internal ComputeOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-03-01-preview")
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ComputeOperations.Restart");
            scope.Start();
            try
            {
        ...
        /// <param name="workspaceName"> Name of Azure Machine Learning workspace. </param>
        /// <param name="computeName"> Name of the Azure Machine Learning compute. </param>
        /// <param name="parameters"> The object for updating schedules of specified ComputeInstance. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> UpdateSchedulesAsync(string resourceGroupName, string workspaceName, string computeName, ComputeSchedules parameters = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ComputeOperations.UpdateSchedules");
            scope.Start();
            try
            {
                return await RestClient.UpdateSchedulesAsync(resourceGroupName, workspaceName, computeName, parameters, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="parameters"> The object for updating schedules of specified ComputeInstance. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response UpdateSchedules(string resourceGroupName, string workspaceName, string computeName, ComputeSchedules parameters = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ComputeOperations.UpdateSchedules");
            scope.Start();
            try
            {
                return RestClient.UpdateSchedules(resourceGroupName, workspaceName, computeName, parameters, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
